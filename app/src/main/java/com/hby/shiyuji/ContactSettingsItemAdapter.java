...
public class ContactSettingsItemAdapter extends ArrayAdapter {
    ...
    public ContactSettingsItemAdapter(Context context, int textViewResourceId, List<ContactSettingsItem> items) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ContactSettingsItem item = (ContactSettingsItem) getItem(position);
