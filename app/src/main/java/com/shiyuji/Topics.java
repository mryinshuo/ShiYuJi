...
public class Topics extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TopicsItemAdapter adapter = new TopicsItemAdapter(this, R.layout.activity_topics_item, itemList);    // 声明adapter
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {//alt+enter 打包
                Intent intent = new Intent(Topics.this, Write.class);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(Topics.this, self_write.class);
        startActivity(intent);
    }
}
