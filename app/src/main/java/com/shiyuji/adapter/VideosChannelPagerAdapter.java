...
public class VideosChannelPagerAdapter extends PagerAdapter {
    ...
    public void init() {
        ...
        officialItems.add(new IndexItem(R.drawable.hequminge, "山西省河曲县 河曲民歌 原生态乡土民歌", R.drawable.quju, "北京曲剧，曲艺单弦牌子曲为主发展而成"));
        officialItems.add(new IndexItem(R.drawable.suonayishu, "河南省沁阳市唢呐《九峰情话》、《沁阳春》", R.drawable.kongquewu, "最负盛名的传统表演性舞蹈傣族民间舞孔雀舞"));
        ...
        unofficialItems.add(new IndexItem(R.drawable.hequminge, "山西省河曲县 河曲民歌 原生态乡土民歌", R.drawable.quju, "北京曲剧，曲艺单弦牌子曲为主发展而成"));
        unofficialItems.add(new IndexItem(R.drawable.suonayishu, "河南省沁阳市唢呐《九峰情话》、《沁阳春》", R.drawable.kongquewu, "最负盛名的传统表演性舞蹈傣族民间舞孔雀舞"));
